...
This is all wrapped inside an anonymous function to make up the bulk of our action.
...
The constants file is rather simple, and might even appear bit useless. *But it's not.* It performns an incredibly important piece of "future-maintenance".

> This allows us to centralize the name of our actions so that we don't have hard-coded action names--*which are used across most levels of the redux dataflow*--sprawled across the application.

Copy/paste this into your `table/constants.js` file.
